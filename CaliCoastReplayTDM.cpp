...
template<> class CaliCoastReplayTDM<DxVer::v9> : public CurClientApp<DxVer::v9> { using T = DxVer::v9;
...
#include "resource\Cali_ps_Dx10.hlsl.h"
		...
		PsConstData.iResolution.x = (float)stPp.BufferDesc.Width;
		PsConstData.iResolution.y = (float)stPp.BufferDesc.Height;
...
template<> class CaliCoastReplayTDM<DxVer::v11> : public CurClientApp<DxVer::v11> { using T = DxVer::v11;
